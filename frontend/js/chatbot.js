    ...
    const locationHTML = `
        <div class="chatbot-message chatbot-bot-message">
            ...
            <div class="chatbot-message-content">
                ...
                <p><strong>📞 Call:</strong> ${HOTEL_DATA.info.phone}</p>
                <p><strong>📱 WhatsApp:</strong> ${HOTEL_DATA.info.whatsapp}</p>
        ...
        <div class="chatbot-message chatbot-bot-message">
            <div class="chatbot-message-content">
                ...
                <div style="display: flex; gap: 10px; flex-wrap: wrap;">
                    <a href="https://wa.me/${HOTEL_DATA.info.whatsapp.replace(/\s+/g, '').replace('+', '')}" target="_blank" class="contact-btn whatsapp-btn primary-contact-btn">
                        <svg class="contact-icon" width="16" height="16" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
